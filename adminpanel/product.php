        ...
        <div class="my-5 col-12 col-md-6">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div>
                    ...
                    <input type="text" id="nama" name="nama" class="form-control" autocomplete="off" placeholder="Input nama produk" required>
                </div>
                <div>
            ...
            <?php 
                ...
                <?php
                    ...
                    ?>
                                <div class="alert alert-warning mt-3" role="alert">
                                    File wajib bertype jpg, png atau gif
                                </div>
                    <?php
                                }
                                else{
                        ...
                        ketersediaan_stok) VALUES ('$kategori', '$nama', '$harga', '$new_name', '$detail', 
                        '$ketersediaan_stok')");
