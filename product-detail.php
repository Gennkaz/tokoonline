...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 offset-lg-1">
                    ...
                    <p class="fs-5">
                        Ketersediaan: <strong><?php echo $produk['ketersediaan_stok']; ?></strong>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid py-5 warna6">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 mb-3">
                    <a href="product-detail.php?nama=<?php echo $data['nama']; ?>">
                        <img src="image/<?php echo $data['foto']; ?>" class="img-fluid img-thumbnail produk-image" alt="">
                    </a>
                </div>
                <?php } ?>
            </div>
